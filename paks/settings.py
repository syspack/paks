...
class EmptySettings:
    ...
    def validate(self):
        ...
        """
        jsonschema.validate(instance=self._settings, schema=paks.schemas.settings)
    ...
    def add(self, key, value):
        ...
        if value not in current:
            ...
            logger.warning(
                "Warning: Check with paks config edit - ordering of list can change."
            )
